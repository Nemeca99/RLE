...
TABLE = 'good_grids_wide250'
CSV_OUT = 'good_grids_wide250_clusters.csv'
PLOT_OUT = 'good_grids_wide250_clusters.png'
SUMMARY_OUT = 'good_grids_wide250_cluster_summary.txt'
...
def main():
    ...
    plt.xlabel('PCA 1')
    plt.ylabel('PCA 2')
    plt.title('good_grids_wide250: KMeans Clusters (PCA 2D)')
    plt.legend()
    plt.tight_layout()
